...
namespace GameForum.ApplicationLogic.Services
{
    public class UserService
    {
        ...
        private Abstractions.IGame gameRepository;
        private IComment commentRepository;

        public UserService(IUser userRepository, Abstractions.IGame gameRepository, IComment commentRepository)
        {
        ...
        {
            var user = new Model.User() { Email = email, Username = email, Password = password, IsAdmin = isAdmin, ID = id };
